...
def edge(img):
    ...
    edge_output=cv.Canny(xgrad,ygrad,100,200)
...
os.chdir('C:\\Users\\邵屹宁\\Desktop\\Train_ori+edges\\train\\')
...
for filename in os.listdir('C:\\Users\\邵屹宁\\Desktop\\Train_ori+edges\\train\\'): 
    ...
    if(str(filename).split(".")[-3] == "fake"):
        cv.imwrite("J:\\100200\\"+"fake.100200"+str(i).zfill(6)+".png",edge_output)
        print(i)
    else:
        cv.imwrite("J:\\100200\\"+"fake.100200"+str(i).zfill(6)+".png",edge_output)
