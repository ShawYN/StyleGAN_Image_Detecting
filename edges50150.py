...
for filename in os.listdir('C:\\Users\\邵屹宁\\Desktop\\Train_ori+edges\\train\\'): 
    ...
    if(str(filename).split(".")[-3] == "fake"):
        cv.imwrite("C:\\Users\\邵屹宁\\Desktop\\Train_ori+edges\\Edges100200\\"+"fake.50150"+str(i).zfill(6)+".png",edge_output)
    else:
        cv.imwrite("C:\\Users\\邵屹宁\\Desktop\\Train_ori+edges\\Edges100200\\"+"real.50150"+str(i).zfill(6)+".png",edge_output)
